...
<div class="custom-header-button-wrapper">
	...
	?>
	<a class="hallura-button" href="<?php echo esc_url( $button_url ); ?>" target="<?php echo esc_attr( $button_target ); ?>" rel="nofollow" style="margin-top: 30px; display: <?php echo esc_attr( $button_display ); ?>;">
